...
contract("Users", function (accounts) {
  ...
  it("should not create same user more than once", async function () {
    await users.signup(ethers.utils.formatBytes32String("Harry"));
    await assertRevert(
      users.signup(ethers.utils.formatBytes32String("Harry")),
  ...
  it("should fetch all users", async function () {
    ...
    await users.signup(ethers.utils.formatBytes32String("Ron"), {
      from: accounts[2],
    });
